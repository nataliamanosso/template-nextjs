...
import { ContractCard } from '@/components/cruds/card-list/list/card/contract-card'
...
import { ContractsListFilters } from '@/components/cruds/card-list/list/contracts-list-filters'
